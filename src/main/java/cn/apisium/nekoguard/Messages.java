...
public final class Messages {
    ...
    public void sendQueryCommandMessage(@NotNull final CommandSender sender, @Nullable String type, final int page, @Nullable final Consumer<SelectQueryImpl> fn) {
        ...
        final String type1;
        if (type != null && !CommandSenderType.getValueList().contains(type)) type1 = Utils.getPlayerUUIDByName(type, sender);
        else type1 = type;
    ...
    public void sendQueryChatMessage(@NotNull final CommandSender sender, @Nullable final String player0, final int page, @Nullable final Consumer<SelectQueryImpl> fn) {
        Objects.requireNonNull(sender);
        final String player = Utils.getPlayerUUIDByName(player0, sender);
    ...
    public void sendSessionMessage(@NotNull final CommandSender sender, final int page, @Nullable final Consumer<SelectQueryImpl> fn) {
        Objects.requireNonNull(sender);
